...
const commentsGet = {
  ...
  items: [
    ...
    },
    {
      ...
      target: "hobby",
      text: "Скачки это круто )))",
      to: {
        _id: "jfhdjfdsfhfjsdfkjsdhfdj",
        name: "Руслан",
        email: "Chaim.Armstrong@gmail.com",
      },
    },
    {
      _id: "bad224dbc4a601caff7e0b2c4",
      from: {
        _id: "e638ad9jfhdjfdsfhfjsdfkjsdhfdjbce6d7efd1b5b035b",
        name: "Руслан",
        email: "Anita93@hotmail.com",
      },
      target: "edu",
      text: "Универ шляпа",
      to: {
        _id: "abfccdajfhdjfdsfhfjsdfkjsdhfdja23e0bd1c4448d2f3",
        name: "Роман Митаки",
        email: "Chaim.Armstrong@gmail.com",
      },
    },
    {
      _id: "c2f15f9b4315bb20aebf9a1d3",
      from: {
        _id: "e638ad9bjfhdjfdsfhfjsdfkjsdhfdjce6d7efd1b5b035b",
        name: "Роман Митаки",
        email: "Anita93@hotmail.com",
      },
      target: "status",
      text: "Симпатичная семейка",
      to: {
        _id: "abfccdaajfhdjfdsfhfjsdfkjsdhfdj23e0bd1c4448d2f3",
        name: "Екатерина Бурмакина",
        email: "Chaim.Armstrong@gmail.com",
      },
    },
    {
      _id: "38eb4bbe3da2fcf2d4cfcd592",
      from: {
        _id: "e638ad9bcjfhdjfdsfhfjsdfkjsdhfdje6d7efd1b5b035b",
        name: "Екатерина Бурмакина",
        email: "Anita93@hotmail.com",
      },
      target: "job",
      text: "Где работаеш?",
      to: {
        _id: "abfccdaa23jfhdjfdsfhfjsdfkjsdhfdje0bd1c4448d2f3",
        name: "Александр Огородников",
        email: "Chaim.Armstrong@gmail.com",
      },
    },
    {
      _id: "0ebcdb97d72b2b17345c30c81",
      from: {
        _id: "e638ad9bcejfhdjfdsfhfjsdfkjsdhfdj6d7efd1b5b035b",
        name: "Александр Огородников",
        email: "Anita93@hotmail.com",
      },
      target: null,
...
export {
  commentsGet,
  profilesId1Get,
  profilesId1ReactionsGet,
  profilesId2Get,
  profilesId2ReactionsGet,
  profilesGet,
  usersGet,
};
